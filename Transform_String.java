...
low=mid+1;
    ...
    public static void main(String[] args) {
        ...
        while (testCases-- > 0) {
            ...
            long lengthA = strA.length(); 

            if (lengthA < strB.length()) {
            ...
            long result = 0; 
            long indexB = strB.length() - 1;

            long[] positions = new long[(int) lengthA];
            ...
            for (long i = lengthA - 1; i >= 0; i--) {

                if (indexB >= 0 && strB.charAt((int) indexB) == strA.charAt((int) i)) {
            ...
            long count = 1, matchedCount = 0; 
            for (long i = 0; i < lengthA; i++) 
            {
                if (positions[(int) i] == 0) {
