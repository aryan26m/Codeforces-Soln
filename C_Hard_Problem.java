...
low=mid+1;
    ...
    public static void main(String[] args) {
        ...
        while (testCases-- > 0) {
            ...
            int groupC = sc.nextInt();
            long totalSeats = 0;
            long availableSeats1 = maxSeats, availableSeats2 = maxSeats;

            if (groupA <= maxSeats) {
                totalSeats += groupA;
                availableSeats1 -= groupA;
            } else {
                totalSeats += maxSeats;
                availableSeats1 = 0;
            }
            ...
            if (groupB <= maxSeats) {
                totalSeats += groupB;
                availableSeats2 -= groupB;
            } else {
                availableSeats2 = 0;
                totalSeats += maxSeats;
            }

            long remainingSeats = availableSeats1 + availableSeats2;
            if (remainingSeats >= groupC) {
                totalSeats += groupC;
            } else {
