...
low=mid+1;
    ...
    public static void main(String[] args) {
        ...
        int l=0;
        int r=n-1;
        while (l < n && arr[l] == obt[l]) {
            l++;
        }
        while (true) {  
            while (r >= 0 && arr[r] == obt[r]) { 
                r--;
            }
            if (interchange(arr, obt, l, r)==true) {
                break;
            }
            else{
                r--;
...
public static boolean interchange(int arr[],int []obt,int p1,int p2){
   int n=arr.length;
