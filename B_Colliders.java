...
public static int visit[]=new int[x];
public static int checker[]=new int[x];
public static int spf[]=new int[x];
    ...
    public static void main(String[] args) {
        ...
        while(m-- >0) {
            ...
            //  System.out.println(ch);
             ArrayList <Integer> fact=factor(no);
             if (ch.charAt(0)=='+') {
                if (checker[no]==1) {
                    ...
                    for(int i=0;i<fact.size();i++){
                        if (visit[fact.get(i)]!=0) {
                            exit=true;
                            System.out.println("Conflict with "+visit[fact.get(i)]);
                            break;
                        }
                    }
                    if (exit==false) {
