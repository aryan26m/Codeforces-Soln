...
low=mid+1;
    ...
    public static void main(String[] args) {
        ...
        int t = sc.nextInt();
        while (t-- > 0) {
            long hhh = sc.nextLong();
            long kk = sc.nextLong();

            long sum_hhh = factorize(hhh);
            long sum_m_total = floor_log2(kk);
            long maxBattles = sum_hhh + sum_m_total;

            System.out.println(maxBattles);
        }
    }
    ...
    static long factorize(long hhh) {
        long sum_hhh = 0;
        while (hhh > 1) {
            sum_hhh++;
            hhh /= spf[(int) hhh];
    ...
    static long floor_log2(long kk) {
        return (long) (Math.log(kk) / Math.log(2));
    }
