...
low=mid+1;
    ...
    public static void main(String[] args) {
        ...
        int both=sc.nextInt();
        int shop=sc.nextInt();
       ArrayList<Integer> usb1=new ArrayList<>();
       ...
       while (j<ps1.size()) {
        ...
        ArrayList<Integer> both1=new ArrayList<>();
        while (i<usb1.size()) {
            both1.add(usb1.get(i));
            i++;
        }
        while (j<ps1.size()) {
            both1.add(ps1.get(j));
        ...
        Collections.sort(both1);
        for(int k=0;k<both1.size();k++){
            if(both>0){
                ans+=both1.get(k);
                both--;
                cnt++;
